...
const TYPEWRITER_TEXT = ' Join the Learning Revolution';
  ...
  return (
    <section ref={container} className={`relative py-16 md:py-24 overflow-hidden ${className}`}>
      ...
      <div className="cta-content relative z-10 container mx-auto px-4 text-center">
        ...
        >
          {/* Badge (now h2 with typewriter) */}
          <div className="mb-8" ref={badgeRef}>
            <AnimatedTitle
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
            <Link to={isAuthenticated ? (hasActiveGoal() ? "/learning-dashboard" : "/assessment") : "/auth"}>
              <Button
                variant="outline"
                size="lg"
                className="text-[#111111] bg-white border-2 border-transparent hover:text-white hover:bg-[#111111] hover:border-white font-bold shadow-lg hover:shadow-xl transition-all duration-300 group"
              >
                Start Free Trial
