...
export const DailyReportTable = ({
  ...
  return (
    <div className="bg-[#181D24] border-sky-200/50 dark:bg-gray-800/60 dark:border-gray-700/50 border border-mint-200 rounded-3xl shadow-2xl p-8">
                  ...
                  >
                    <div className="flex items-start justify-between">
                      ...
                      <div className="flex items-center gap-2 ml-4">
                        ...
                        {task.status === "completed" && task.submissionFile && (
                          <Button
                            onClick={async (e) => {
                              e.stopPropagation();
                              try {
