      ...
      try {
        ...
        for (let day = 1; day <= daysInMonth; day++) {
          ...
          try {
            ...
            console.log(`[CalendarSection] Fetching tasks for date ${dateStr} with goalId: ${activeGoalId}`);
            ...
            if (!abortController.signal.aborted) {
              ...
              console.log(`[CalendarSection] Found ${dayTasks.length} tasks, filtered to ${filteredTasks.length} for date ${dateStr} with goalId: ${activeGoalId}`);
