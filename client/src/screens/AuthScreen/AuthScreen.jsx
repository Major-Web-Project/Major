            ...
            <div className="space-y-8">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                {features.map((feature, index) => (
                  <div
                    key={index}
                    className="bg-mint-100 rounded-2xl p-6 border border-mint-200 dark:bg-white/10 dark:border-white/20"
                  >
                    <div className="text-3xl mb-3">{feature.icon}</div>
                    <h3 className="text-indigo-700 font-bold text-lg mb-2 dark:text-white">
                      {feature.title}
                    </h3>
                    <p className="text-mint-700 text-sm dark:text-gray-300">
                      {feature.description}
                    </p>
                  </div>
                ))}
              ...
              <div className="space-y-4">
                <h3 className="text-indigo-700 font-bold text-xl mb-4 dark:text-white">
