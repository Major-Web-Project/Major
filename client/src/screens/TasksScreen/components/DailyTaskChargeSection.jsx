                  ...
                  <div className="p-6">
                    <div className="flex items-start justify-between gap-6">
                      <div className="flex-1">
                        ...
                        <p className="text-gray-300 text-base mb-6 leading-relaxed bg-black/20 p-4 rounded-lg border border-white/10">
                          {task.description}
                        </p>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 text-sm mb-6">
                          <div className="flex items-center gap-3 bg-white/10 p-4 rounded-xl border border-white/20">
                            ...
                            <div>
                              <div className="text-gray-400 text-xs">Assigned by</div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                          <div className="bg-gradient-to-r from-indigo-500/20 to-purple-500/20 p-4 rounded-xl border border-indigo-400/30">
                            ...
                            <div className="text-white font-bold text-lg">{task.gradeWeight}%</div>
                          ...
                          <div className="bg-gradient-to-r from-orange-500/20 to-red-500/20 p-4 rounded-xl border border-orange-400/30">
                            ...
                            <div className="text-white font-bold text-lg">{task.currentAttempt}/{task.maxAttempts}</div>
                          ...
                          <div className="bg-gradient-to-r from-green-500/20 to-emerald-500/20 p-4 rounded-xl border border-green-400/30">
                            ...
                            <div className="text-white font-bold text-lg">{task.skillsGained.length}</div>
