      ...
      <div className="container mx-auto px-4 sm:px-8">
          ...
          {footerData.map((section, index) => (
            ...
            >
              <div className="flex items-center gap-3 mb-2">
                ...
                <h3 className="font-bold text-xl sm:text-2xl text-cyan-400 tracking-wide dark:text-cyan-400 text-indigo-700">
                  {section.title}
                </h3>
              </div>
              <p className="text-gray-300 text-base sm:text-lg leading-relaxed whitespace-pre-line dark:text-gray-300 text-sky-700">
                {section.content}
              </p>
            </div>
          ))}
        ...
        <div className="mt-12 sm:mt-16 pt-8 border-t border-white/10">
            ...
            <div className="flex items-center space-x-6">
              {socialLinks.map((social, index) => (
                <a
                  key={index}
                  href={social.href}
                  className="flex items-center gap-2 text-gray-400 hover:text-cyan-400 transition-all duration-300 hover:scale-110 group dark:text-gray-400 text-indigo-700"
                >
          ...
          <div className="mt-8 text-center">
            <p className="text-gray-400 text-sm sm:text-base dark:text-gray-400 text-sky-700">
            ...
            <div className="flex justify-center space-x-6 mt-4">
              <a
                href="#"
                className="text-gray-400 hover:text-cyan-400 transition-colors text-sm dark:text-gray-400 text-indigo-700"
              >
                Privacy Policy
              </a>
              <a
