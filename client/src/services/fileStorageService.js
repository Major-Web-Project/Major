  ...
  async storeFile(fileKey, fileData) {
    try {
      ...
      return new Promise((resolve, reject) => {
        ...
        request.onsuccess = () => {
          console.log('[FileStorage] File stored successfully:', fileKey);
          resolve(fileRecord);
        };
  ...
  async getFile(fileKey) {
    try {
      ...
      return new Promise((resolve, reject) => {
        ...
        request.onsuccess = () => {
          if (request.result) {
            console.log('[FileStorage] File retrieved successfully:', fileKey);
  ...
  async deleteFile(fileKey) {
    try {
      ...
      return new Promise((resolve, reject) => {
        ...
        request.onsuccess = () => {
          console.log('[FileStorage] File deleted successfully:', fileKey);
          resolve(true);
        };
  ...
  async getFilesByTaskId(taskId) {
    try {
      ...
      return new Promise((resolve, reject) => {
        ...
        request.onsuccess = () => {
          console.log('[FileStorage] Files retrieved for task:', taskId, request.result.length);
          resolve(request.result);
        };
      ...
      return new Promise((resolve, reject) => {
        ...
        request.onsuccess = (event) => {
          ...
          if (cursor) {
            ...
            console.log('[FileStorage] Cleanup completed, deleted files:', deletedCount);
