  ...
  motivation: [
    ...
    },
    {
      ...
      options: [
        {
          value: "very_urgent",
          label: "Very urgent (within 3 months)",
          weight: 5,
        },
        { value: "urgent", label: "Urgent (within 6 months)", weight: 4 },
        {
          value: "moderate",
          label: "Moderate timeline (within 1 year)",
          weight: 3,
        },
...
class AILearningAssistant {
  ...
  async createGoalWithTasks(goalData) {
    try {
      console.log(`[AI Service] Creating goal with unlimited time for complete task generation`);
      console.log(`[AI Service] Goal duration: ${goalData.timeline || goalData.timeframe || 3} months`);
  ...
  async generateRoadmapWithAI(goalData) {
    try {
      console.log(`[AI Service] Generating roadmap with unlimited time`);
