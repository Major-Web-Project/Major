...
export const completeCurrentGoal = () => {
    ...
    const completedGoal = {
        completedAt: new Date().toISOString(),
        userProfile: JSON.parse(localStorage.getItem('aiLearning_userProfile') || '{}'),
        goalData: JSON.parse(localStorage.getItem('aiLearning_goalData') || '{}'),
        roadmap: JSON.parse(localStorage.getItem('aiLearning_roadmap') || '{}'),
        learningData: JSON.parse(localStorage.getItem('aiLearning_learningData') || '{}'),
        assessmentData: JSON.parse(localStorage.getItem('aiLearning_assessmentData') || '{}')
    };

    // Save to completed goals history
    const completedGoals = JSON.parse(localStorage.getItem('aiLearning_completedGoals') || '[]');
    completedGoals.push(completedGoal);
    localStorage.setItem('aiLearning_completedGoals', JSON.stringify(completedGoals));
...
export const getGoalProgress = () => {
    const learningData = JSON.parse(localStorage.getItem('aiLearning_learningData') || '{}');
    const roadmap = JSON.parse(localStorage.getItem('aiLearning_roadmap') || '{}');
