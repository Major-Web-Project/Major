...
export default function DashboardPage() {
  ...
  const { activeGoalId, hasGoals, getActiveGoal, initializeGoals, setActiveGoal, goals } = useGoalStore();
  ...
  useEffect(() => {
    async function fetchData() {
      try {
        setLoading(true);
        // Ensure goals are initialized
        if (!hasGoals()) {
          await initializeGoals();
        }
        // Auto-select most recent goal if none
  ...
  }, [activeGoalId, hasGoals, fetchDashboardData, initializeGoals, setActiveGoal, goals]);
