...
// NEW: Upload and verify submission, store in GridFS
router.post(
...
// NEW: Stream/view stored submission securely
router.get("/:id/submission", streamTaskSubmission);
