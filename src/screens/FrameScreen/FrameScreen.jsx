      ...
      <div className="relative z-20 w-full">
        <div className="relative w-full overflow-x-hidden">
          ...
          <div className="relative w-full pt-4 sm:pt-8 px-4 sm:px-6 lg:px-8">
            <Card className="relative mx-auto w-full max-w-7xl rounded-3xl sm:rounded-[60px] border-none shadow-2xl backdrop-blur-md bg-white/10 border border-white/20 overflow-hidden">
              ...
              <div className="flex flex-col lg:flex-row relative z-10">
                ...
                <div className="relative w-full lg:w-[600px] xl:w-[700px] h-[400px] sm:h-[500px] lg:h-[700px] p-4">
                  <div className="absolute inset-0 bg-gradient-to-br from-blue-500/10 to-purple-500/10 rounded-r-3xl sm:rounded-r-[60px]" />
