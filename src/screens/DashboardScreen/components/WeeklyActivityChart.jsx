      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-6">
          <div className="flex items-center gap-2">
            ...
            <span className="text-white text-sm font-medium">Goal</span>
          </div>
          <div className="flex items-center gap-2">
        ...
        <div className="text-gray-400 text-sm">Weekly Progress %</div>
      </div>

      {/* Chart Container */}
      <div className="relative bg-gray-800/60 rounded-xl p-6 border border-gray-700/50">
        {/* Y-axis labels */}
        <div className="absolute left-2 top-4 bottom-16 flex flex-col gap-y-4 text-gray-400 text-xs">
          <span>100%</span>
          <span>80%</span>
          <span>60%</span>
          <span>40%</span>
